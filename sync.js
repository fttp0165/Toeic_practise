...
if(firebaseConfig.apiKey.startsWith("PASTE")){
  ...
  function norm(d){ return { start:(d&&d.start)||"", tasks:(d&&d.tasks)||{}, vocab:(d&&d.vocab)||{}, log:(d&&d.log)||{}, libs:(d&&d.libs)||[], projects:(d&&Array.isArray(d.projects))?d.projects:[], curproj:(d&&d.curproj)||"" }; }
